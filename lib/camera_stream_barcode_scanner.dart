...
import 'package:ml_vision_barcode_scan/colors.dart';
import 'package:ml_vision_barcode_scan/painters.dart';
import 'package:ml_vision_barcode_scan/scanner_utils.dart';
import 'package:ml_vision_barcode_scan/window_painter.dart';
  ...
  void _switchAnimationState(AnimationState newState) {
    if (newState == AnimationState.search) {
      ...
      if (_currentState == AnimationState.barcodeNear) {
        begin = ui.lerpDouble(0.0, 0.5, _animationController.value);
